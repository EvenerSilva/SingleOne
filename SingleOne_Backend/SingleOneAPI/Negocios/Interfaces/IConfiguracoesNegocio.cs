...
namespace SingleOneAPI.Negocios.Interfaces
{
    public interface IConfiguracoesNegocio
    {
        ...
        /// <summary>
        /// ✅ NOVO: Retorna localidades de uma empresa específica (para cascata)
        /// </summary>
        List<Localidade> ListarLocalidadesDaEmpresa(int empresaId);
        ...
        /// <summary>
        /// ✅ NOVO: Retorna filiais de uma empresa específica (para cascata)
        /// </summary>
        List<Filial> ListarFiliaisDaEmpresa(int empresaId);
        /// <summary>
        /// ✅ NOVO: Retorna filiais de uma empresa em uma localidade específica (para cascata)
        /// </summary>
        List<Filial> ListarFiliaisPorLocalidade(int empresaId, int localidadeId);
