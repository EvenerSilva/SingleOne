...
{
    public class VwUltimasRequisicaoBYODMap : IEntityTypeConfiguration<VwUltimasRequisicaoBYOD>
    {
        public void Configure(EntityTypeBuilder<VwUltimasRequisicaoBYOD> entity)
        {
            entity.HasNoKey();

            entity.ToView("vwUltimasRequisicaoBYOD");
