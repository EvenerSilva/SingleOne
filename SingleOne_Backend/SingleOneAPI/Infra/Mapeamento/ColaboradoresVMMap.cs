...
namespace SingleOneAPI.Infra.Mapeamento
{
    public class ColaboradoresVMMap : IEntityTypeConfiguration<ColaboradoresVM>
    {
        public void Configure(EntityTypeBuilder<ColaboradoresVM> builder)
        {
            ...
            builder.Property(c => c.Setor).HasColumnName("setor");
            builder.Property(c => c.LocalidadeDescricao).HasColumnName("localidadedescricao");
            builder.Property(c => c.LocalidadeCidade).HasColumnName("localidadecidade");
            builder.Property(c => c.LocalidadeEstado).HasColumnName("localidadeestado");
            builder.Property(c => c.Dtadmissao).HasColumnName("dtadmissao").HasColumnType("timestamp without time zone");
            builder.Property(c => c.Dtdemissao).HasColumnName("dtdemissao").HasColumnType("timestamp without time zone");
            builder.Property(c => c.Dtcadastro).HasColumnName("dtcadastro").HasColumnType("timestamp without time zone");
            builder.Property(c => c.MatriculaSuperior).HasColumnName("matriculasuperior");
        }
    }
}
