...
namespace SingleOne.Controllers
{
    ...
    public class RelatorioController : ControllerBase
    {
        ...
        [HttpGet("[action]/{cliente}/{pagina}/{relatorio}/{pesquisa}/{pageSize}", Name ="MovimentacoesColaboradores")]
        ...
        {
            return _negocio.MovimentacoesColaboradores(cliente, pagina, relatorio, pesquisa, pageSize);
        }
