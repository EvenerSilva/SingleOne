-- =====================================================
-- SCRIPT CORRIGIDO PARA FUNCIONALIDADE DE SINALIZAÇÃO DE SUSPEITAS
-- =====================================================
...
-- =====================================================
-- Nota: A tabela parametros tem estrutura específica com colunas individuais
-- Os parâmetros de sinalização serão configurados via interface administrativa
-- ou através de configurações específicas no código da aplicação
