-- =====================================================
-- SCRIPT PARA FUNCIONALIDADE DE SINALIZAÇÃO DE SUSPEITAS
-- =====================================================
...
VALUES 
    ('SinalizacaoSuspeitas_Habilitado', 'true', 'Habilita/desabilita o sistema de sinalização de suspeitas'),
    ('SinalizacaoSuspeitas_NotificacaoEmail', 'true', 'Envia notificações por email para o time de segurança'),
    ('SinalizacaoSuspeitas_EmailSeguranca', 'seguranca@empresa.com', 'Email do time de segurança para notificações'),
    ('SinalizacaoSuspeitas_PrioridadePadrao', 'media', 'Prioridade padrão para novas sinalizações'),
    ('SinalizacaoSuspeitas_ExpiracaoDias', '30', 'Dias para arquivar automaticamente sinalizações não resolvidas')
...
4. Os parâmetros do sistema serão configurados
