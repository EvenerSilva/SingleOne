-- =====================================================
-- SCRIPT PARA ADICIONAR CAPITAIS E PRINCIPAIS CIDADES (UTF-8)
...
-- Limpar cidades existentes para evitar duplicatas
DELETE FROM cidades WHERE nome IN (
...
-- Adicionar TODAS as capitais brasileiras com codificação correta
