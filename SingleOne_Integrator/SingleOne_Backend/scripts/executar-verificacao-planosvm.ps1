# Script PowerShell para verificar e recriar a view planosvm
Write-Host "🔍 VERIFICANDO E RECRIANDO VIEW PLANOSVM" -ForegroundColor Cyan
...
try {
    ...
    # Executar script SQL
    $SqlScript = Get-Content ".\verificar-view-planosvm.sql" -Raw
...
Write-Host "1. Verificar se a view foi criada: SELECT * FROM planosvm LIMIT 1;" -ForegroundColor White
